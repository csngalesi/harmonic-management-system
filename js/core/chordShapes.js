...
(function () {
    ...
    // Afinação: S1=D4  S2=G4  S3=B4  S4=D5
    // S1 fret n → D4+n  |  S2 fret n → G4+n  |  S3 fret n → B4+n  |  S4 fret n → D5+n
    // Todas as posições são FECHADAS (sem corda solta / sem 0).
    const cavaco = {
        // ── Major ────────────────────────────────────────────────────────────
        'C':   [5, 5, 5, 5],   // G C E G  — barre V
        'C#':  [1, 1, 2, 3],   // D# G# C# F
        'Db':  [1, 1, 2, 3],
        'D':   [4, 2, 3, 4],   // F# A D F#
        'D#':  [1, 3, 4, 5],   // D# A# D# G
        ...
        'Gb':  [4, 3, 2, 4],
        'G':   [5, 4, 3, 5],   // G B D G
        'G#':  [1, 1, 1, 1],   // D# G# C G#  — barre I
        'Ab':  [1, 1, 1, 1],
        'A':   [2, 2, 2, 2],   // E A C# E  — barre II
        'A#':  [3, 3, 3, 3],   // F A# D F  — barre III
        'Bb':  [3, 3, 3, 3],
        'B':   [1, 4, 4, 4],   // D# B D# F#
        ...
        // ── Diminished ───────────────────────────────────────────────────────
        'Bdim':  [3, 4, 3, 3],  // F B D F
        'Cdim':  [4, 4, 3, 4],  // F# B D F# (= Bdim shape +1, proxy)
        'F#dim': [4, 3, 2, 1],  // F# A C Eb — fechado ✓
        'Gbdim': [4, 3, 2, 1],
    };
